...
MAX_ROUNDS     = 50       # Escalate: 20 → 50 → 70 → 100
...
- Rounds 16-30:  Drive cross-debate. Select speakers who will disagree with the
                 current dominant C-level view.
- Rounds 31-42:  Push toward named product forms. Select Product_Thinker frequently.
- Rounds 43-50:  Stress-test and rank. Select Fermentation_Veteran and BioChem_Professor
