...
MAX_ROUNDS     = 80       # Escalate: 20 → 50 → 80 → 100
...
PHASE AWARENESS:
- Rounds 1-15:   Ensure all 5 lifecycle contexts (C1-C5) get raised. If C3 or C2
                 have not been mentioned yet, select someone likely to raise them.
- Rounds 16-35:  Drive cross-debate. Select speakers who will disagree with the
                 current dominant C-level view.
- Rounds 36-55:  Push toward named product forms. Select Product_Thinker frequently.
- Rounds 56-70:  Stress-test and rank. Select Fermentation_Veteran and BioChem_Professor
                 to punch holes in leading concepts.
- Rounds 71-80:  Final sharpening. Select MSAT_Lead and Product_Thinker to nail down
                 exact interaction model, output format, and wedge mechanic.
