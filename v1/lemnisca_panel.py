...
6. Ensure all 6 participants get meaningful airtime — do not let 2-3 dominate

FREE WEDGE ENFORCEMENT:
If any proposed solution would require payment, bespoke delivery, custom onboarding,
or resembles a consulting engagement — select a speaker who will challenge it on the
free-wedge constraint. Do not let a non-compliant idea go unchallenged.

KEY RULE: Productive disagreement beats polite consensus. Select speakers who create
useful friction. A panel that agrees quickly has failed.
